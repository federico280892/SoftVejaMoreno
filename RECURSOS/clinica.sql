...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2021 a las 01:42:27
...
--
-- Estructura de tabla para la tabla `categorias_iva`
--
...
--
-- Volcado de datos para la tabla `categorias_iva`
--

INSERT INTO `categorias_iva` (`id`, `razon_social`) VALUES
...
(9, 'IVA Responsable Inscripto - Agente de Percepción'),
(10, 'Monotributista Social'),
(11, 'IVA No Alcanzado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `coberturas_sociales`
--

CREATE TABLE `coberturas_sociales` (
  `id` int(255) NOT NULL,
  `codigo` varchar(100) NOT NULL,
  `cobertura_social` varchar(100) NOT NULL,
  `plus` varchar(100) NOT NULL,
  `tipo` varchar(100) NOT NULL,
  `modulada` int(50) NOT NULL,
  `telefono` varchar(100) NOT NULL,
  `celular` varchar(50) NOT NULL,
  `email` varchar(100) NOT NULL,
  `cupo_por_dia` varchar(100) NOT NULL,
  ...
  `ingresos_brutos` varchar(100) NOT NULL,
  `val_con` varchar(100) NOT NULL,
  `gal_qui` varchar(100) NOT NULL,
  `gal_pra` varchar(100) NOT NULL,
  `gas_pens` varchar(100) NOT NULL,
  `gto_quir` varchar(100) NOT NULL,
  `gto_radi` varchar(100) NOT NULL,
  `porcentaje_gral` varchar(100) NOT NULL,
  `paga_categoria` varchar(100) NOT NULL,
  `aumento_en_liq` varchar(100) NOT NULL,
  `porcentaje_hon` varchar(100) NOT NULL,
  `porcentaje_gtos` varchar(100) NOT NULL,
  `porcentaje_n1` varchar(100) NOT NULL,
  `porcentaje_n2` varchar(100) NOT NULL,
  `porcentaje_n3` varchar(100) NOT NULL,
  `modelo_generacion_txt` varchar(100) NOT NULL,
  `long_orden` varchar(100) NOT NULL,
  `long_n_afiliado` varchar(100) NOT NULL,
  `alerta_secretarias_cirugia` varchar(100) NOT NULL,
  `alerta` varchar(100) NOT NULL,
  `activo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `coberturas_sociales`
--

INSERT INTO `coberturas_sociales` (`id`, `codigo`, `cobertura_social`, `plus`, `tipo`, `modulada`, `telefono`, `celular`, `email`, `cupo_por_dia`, `domicilio`, `localidad`, `codigo_postal`, `provincia`, `descripcion`, `long_barra`, `categoria_iva`, `cuit`, `ingresos_brutos`, `val_con`, `gal_qui`, `gal_pra`, `gas_pens`, `gto_quir`, `gto_radi`, `porcentaje_gral`, `paga_categoria`, `aumento_en_liq`, `porcentaje_hon`, `porcentaje_gtos`, `porcentaje_n1`, `porcentaje_n2`, `porcentaje_n3`, `modelo_generacion_txt`, `long_orden`, `long_n_afiliado`, `alerta_secretarias_cirugia`, `alerta`, `activo`) VALUES
(1, '197', 'DOS', '0.00', '1', 1, '2646026229', '', '', '', '', '963', '', '23', '---', '', '5', '', '', '', '', '', '', '', '', '80', '', '', '', '', '', '', '', '', '', '', '', '0', '1'),
(3, '283', 'OSDE', '45', '1', 0, '', '', '', '', '', '156', '', '2', 'Test', '', '1', '', '', '', '', '', '', '', '', '100', '', '', '', '', '', '', '', '', '', '', '', '0', '0'),
(4, '108', 'SANCOR', '0.00', '1', 0, '', '', '', '', '', '1260', '', '9', '---', '', '3', '', '', '', '', '', '', '', '', '100', '', '', '', '', '', '', '', '', '', '', '', '0', '1'),
(47, '434', 'PARTICULAR', '0.00', '1', 0, '', '', '', '', '', '300', '', '3', '', '', '2', '', '', '', '', '', '', '', '', '0', '', '', '', '', '', '', '', '', '', '', '', '0', '1'),
(52, '359', 'UPCN', '150.00', '2', 2, '(0264)420900', '+54(343)4-759-718', 'upcn@obrasocial.com', '5', 'FLORIDA 100', '1741', '5000', '19', '26', '25', '1', '23-34921176-9', '000-157080-8', '1500', '10', '11', '12', '13', '14', '20', 'S', '16', '17', '18', '19', '20', '21', '22', '23', '24', '27', '28', '1');
...
INSERT INTO `consultorios` (`id`, `id_medico`, `lun`, `mar`, `mie`, `jue`, `vie`, `sab`, `dom`) VALUES
(1, 28, 1, 2, 3, 2, 2, 3, '-'),
(2, 40, 2, 2, 1, 2, 1, 3, '-'),
(3, 48, 1, 2, 1, 2, 1, 3, '-');
...
CREATE TABLE `convenios` (
  ...
  `id_cobertura_social` int(11) NOT NULL,
  `id_prestacion` int(11) NOT NULL,
  `precio_fijo` varchar(100) NOT NULL,
  `codigo_cobertura_social` varchar(100) NOT NULL,
...
INSERT INTO `convenios` (`id`, `fecha`, `vencimiento`, `id_cobertura_social`, `id_prestacion`, `precio_fijo`, `codigo_cobertura_social`, `fecha_carga`, `usuario`) VALUES
(211, '2021-05-02', '2021-11-30', 197, 11, '200', '100', '03-05-2021 02:31:45', '1'),
(212, '2021-05-02', '2021-11-30', 197, 12, '300', '101', '03-05-2021 02:31:45', '1'),
(213, '2021-05-02', '2021-11-30', 197, 13, '400', '102', '03-05-2021 02:31:45', '1'),
(214, '2021-05-02', '2021-11-30', 197, 14, '500', '103', '03-05-2021 02:31:45', '1'),
(215, '2021-05-02', '2021-11-30', 197, 15, '600', '104', '03-05-2021 02:31:45', '1'),
(216, '2021-05-02', '2021-11-30', 197, 16, '700', '105', '03-05-2021 02:31:45', '1'),
(217, '2021-05-02', '2021-11-30', 283, 11, '150', '200', '03-05-2021 02:53:25', '1'),
(218, '2021-05-02', '2021-11-30', 283, 12, '150', '201', '03-05-2021 02:53:25', '1'),
(219, '2021-05-02', '2021-11-30', 283, 13, '200', '202', '03-05-2021 02:53:25', '1'),
(220, '2021-05-02', '2021-11-30', 283, 14, '205', '203', '03-05-2021 02:53:25', '1'),
(221, '2021-05-02', '2021-11-30', 283, 16, '200', '205', '03-05-2021 02:53:25', '1');
...
--
-- Volcado de datos para la tabla `dias_no_laborales`
--

INSERT INTO `dias_no_laborales` (`id`, `start`, `end`, `overlap`, `display`, `color`, `title`) VALUES
(5, '2021-01-01', '2021-01-02', 'false', 'background', '#ff9f89', 'Año nuevo'),
(7, '2021-01-08', '2021-01-09', 'false', 'background', '#ff9f89', 'Reyes'),
(12, '2021-05-25', '2021-05-26', 'false', 'background', '#ff9f89', 'feriado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dias_sin_atencion_medicos`
--

CREATE TABLE `dias_sin_atencion_medicos` (
  `id` int(255) NOT NULL,
  `start` varchar(50) NOT NULL,
  `fecha_start` varchar(50) NOT NULL,
  `end` varchar(50) NOT NULL,
  `fecha_end` varchar(50) NOT NULL,
  `overlap` varchar(50) NOT NULL,
  `display` varchar(50) NOT NULL,
  `color` varchar(50) NOT NULL,
  `title` varchar(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `dias_sin_atencion_medicos`
--

INSERT INTO `dias_sin_atencion_medicos` (`id`, `start`, `fecha_start`, `end`, `fecha_end`, `overlap`, `display`, `color`, `title`, `id_medico`) VALUES
(55, '2021-04-13', '00:00:00', '2021-04-14', '00:00:00', 'false', 'background', '#ff9f89', 'parto', '40'),
(56, '2021-04-19', '00:00:00', '2021-04-24', '00:00:00', 'false', 'background', '#ff9f89', 'Vacaciones', '40'),
(57, '2021-04-26', '05:21:00', '2021-04-27', '07:22:00', 'false', 'background', '#ff9f89', 'permiso', '40'),
(58, '2021-04-06', '00:00:00', '2021-04-07', '00:00:00', 'false', 'background', '#ff9f89', 'sin atencion', '28'),
(60, '2021-04-27', '08:00:00', '2021-04-28', '10:00:00', 'false', 'background', '#ff9f89', 'sin atencion', '28'),
(63, '2021-05-27', '08:20:00', '2021-05-28', '09:00:00', 'false', 'background', '#ff9f89', 'especial', '28');
...
INSERT INTO `especialidades` (`id`, `especialidad`, `activo`) VALUES
(1, 'OFTALMOLOGíA', '1'),
(2, 'ESTETICA', '1');
...
INSERT INTO `formas_pago` (`id`, `pago`, `descripcion`, `activo`) VALUES
(1, 'EFECTIVO', '-', 1),
...
INSERT INTO `horarios_semanales` (`id`, `id_medico`, `turno`, `apLun`, `ciLun`, `apMar`, `ciMar`, `apMie`, `ciMie`, `apJue`, `ciJue`, `apVie`, `ciVie`, `apSab`, `ciSab`, `apDom`, `ciDom`) VALUES
(1, '28', '1', '08:20:00', '08:20:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '08:00:00', '12:00:00', '00:00:00', '00:00:00', '09:00:00', '17:00:00', '00:00:00', '00:00:00'),
(2, '28', '2', '00:00:00', '00:00:00', '16:00:00', '19:00:00', '00:00:00', '00:00:00', '16:00:00', '20:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00'),
(7, '40', '1', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '09:00:00', '12:00:00', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '09:00:00', '13:00:00', '00:00:00', '00:00:00'),
(8, '40', '2', '16:00:00', '20:00:00', '16:00:00', '20:00:00', '16:00:00', '20:00:00', '16:00:00', '20:00:00', '16:00:00', '20:00:00', '17:00:00', '21:00:00', '00:00:00', '00:00:00'),
(13, '48', '1', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '08:00:00', '12:00:00', '00:00:00', '00:00:00'),
(14, '48', '2', '00:00:00', '00:00:00', '16:00:00', '18:00:00', '16:00:00', '20:00:00', '00:00:00', '00:00:00', '16:00:00', '20:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00');
...
CREATE TABLE `medicos` (
  ...
  `domicilio` varchar(100) NOT NULL,
  `telefono_particular` varchar(50) NOT NULL,
  `celular` varchar(50) NOT NULL,
  `telefono_consultorio` varchar(50) NOT NULL,
  `especialidad` varchar(50) NOT NULL,
  `matricula` varchar(50) NOT NULL,
  `anestesista` varchar(10) NOT NULL,
...
INSERT INTO `medicos` (`id`, `codigo`, `usuario`, `dni`, `apellido`, `nombre`, `domicilio`, `telefono_particular`, `celular`, `telefono_consultorio`, `especialidad`, `matricula`, `anestesista`, `observaciones`, `activo`) VALUES
(28, 911, '5', '96325874', 'VEJA MORENO', 'JUAN RAMóN', 'SAN JUAN', '132465', '(264)5-689-565', '123', '1', '2020-01-02', '1', 'DSFDF', 'true'),
(40, 4747, '2', '36985214', 'FERNANDEZ', 'JOSEFINA', 'CENTRO', '1234568', '(264)1-236-549', '108', '1', '2020-02-18', '0', 'OFTALMóLOGA - M.P. 4747', 'true'),
(48, 4252, '7', '12345678', 'VEJA MAORENO', 'JUAN MARTIN', 'CENTRO', '-', '(264)8-888-888', '-', '1', '2005-03-15', '1', 'OFTALM', 'true');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `medicos_coberturas_sociales`
--

CREATE TABLE `medicos_coberturas_sociales` (
  `id` int(255) NOT NULL,
  `id_medico` varchar(255) NOT NULL,
  `id_cobertura_social` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `medicos_coberturas_sociales`
--

INSERT INTO `medicos_coberturas_sociales` (`id`, `id_medico`, `id_cobertura_social`) VALUES
(23, '28', '4'),
(24, '28', '1'),
(25, '28', '3'),
(26, '40', '1'),
...
CREATE TABLE `mensajes` (
  ...
  `origen` int(50) NOT NULL,
  `destino` int(50) NOT NULL,
  `urgencia` int(10) NOT NULL,
...
INSERT INTO `mensajes` (`id`, `fecha`, `asunto`, `mensaje`, `origen`, `destino`, `urgencia`, `estado`) VALUES
(2, '2021-03-24 00:06:55', 'Confirmar turnos', 'Se deben confirgar los turnos de la doctora Iturrieta', 8, 1, 2, 0),
(6, '2021-03-09 15:24:47', 'Prueba', 'Mensajee', 8, 1, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `otros_consultorios`
--

CREATE TABLE `otros_consultorios` (
  `id` int(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `otros_consultorios`
--

INSERT INTO `otros_consultorios` (`id`, `id_medico`, `lun`, `mar`, `mie`, `jue`, `vie`, `sab`, `dom`) VALUES
(1, 28, 1, 1, 1, 1, 1, 1, 0),
(2, 40, 1, 1, 1, 2, 1, 2, 0),
(3, 48, 0, 0, 0, 0, 0, 0, 0);
...
--
-- Estructura de tabla para la tabla `otros_horarios`
--

CREATE TABLE `otros_horarios` (
  `id` int(255) NOT NULL,
  `id_medico` int(10) NOT NULL,
...
--
-- Volcado de datos para la tabla `otros_horarios`
--

INSERT INTO `otros_horarios` (`id`, `id_medico`, `turno`, `apLun`, `ciLun`, `apMar`, `ciMar`, `apMie`, `ciMie`, `apJue`, `ciJue`, `apVie`, `ciVie`, `apSab`, `ciSab`, `apDom`, `ciDom`, `desde`, `hasta`) VALUES
(1, 28, 1, '09:00:00', '11:00:00', '09:00:00', '11:00:00', '09:00:00', '11:00:00', '09:00:00', '11:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-05-25', '2021-05-30'),
(2, 28, 2, '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-05-25', '2021-05-30'),
(6, 40, 1, '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-03-05', '2021-03-05'),
(7, 40, 2, '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-03-05', '2021-03-05'),
(8, 48, 1, '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-03-05', '2021-03-05'),
(9, 48, 2, '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '2021-03-05', '2021-03-05');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `otros_tiempos`
--

CREATE TABLE `otros_tiempos` (
  `id` int(255) NOT NULL,
  `id_medico` int(255) NOT NULL,
  `lun` varchar(10) NOT NULL,
  `mar` varchar(100) NOT NULL,
  `mie` varchar(100) NOT NULL,
  `jue` varchar(100) NOT NULL,
  `vie` varchar(100) NOT NULL,
  `sab` varchar(100) NOT NULL,
  `dom` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `otros_tiempos`
--

INSERT INTO `otros_tiempos` (`id`, `id_medico`, `lun`, `mar`, `mie`, `jue`, `vie`, `sab`, `dom`) VALUES
(1, 28, '15', '15', '15', '15', '15', '15', '-'),
(2, 40, '15', '15', '15', '15', '15', '15', '-'),
(3, 48, '15', '15', '15', '15', '15', '15', '-');
...
CREATE TABLE `pacientes` (
  ...
  `email` varchar(100) NOT NULL,
  `cobertura_social` varchar(100) NOT NULL,
  `coseguro` varchar(100) NOT NULL,
  `n_carnet` varchar(100) NOT NULL,
  `n_carnet_coseguro` varchar(100) NOT NULL,
...
INSERT INTO `pacientes` (`id`, `DNI`, `apellido`, `nombre`, `fecha_nacimiento`, `sexo`, `domicilio`, `provincia`, `localidad`, `tel1`, `tel2`, `cel`, `email`, `cobertura_social`, `coseguro`, `n_carnet`, `n_carnet_coseguro`, `observacion`) VALUES
(6, '12346545', 'APELLIDO', 'NOMBRE', '1990-05-11', '0', 'RIOJA 150', '19', '1732', '', '', '(264)5-555-555', 'mail@mail.com', '197', '359', 'ACVBHY1459RGHY32584A', 'ABCDEFGHIJKLMN123568', 'NINGUNA'),
(8, '41157219', 'SANTIAGO', 'MACARENA', '1993-10-05', '1', 'LAVALLE 1450 SUR', '19', '1735', '-', '-', '(264)1-234-567', 'macarenasantiagogarcia@gmail.com', '0', '0', '123456789QWERTYUIOPS', '', 'PRESIóN');
...
--
-- Estructura de tabla para la tabla `pagos_metodos_de_pago`
--

CREATE TABLE `pagos_metodos_de_pago` (
  `id` int(255) NOT NULL,
  `id_pago` int(255) NOT NULL,
  `id_metodo_pago` int(255) NOT NULL,
  `banco` int(255) NOT NULL,
  `localidad` varchar(100) NOT NULL,
  `n_cuenta` varchar(100) NOT NULL,
  `n_cheque` varchar(100) NOT NULL,
  `f_emision` varchar(100) NOT NULL,
  `f_vencimiento` varchar(100) NOT NULL,
  `monto` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `pagos_prestaciones`
--

CREATE TABLE `pagos_prestaciones` (
  `id` int(255) NOT NULL,
  `id_pago` int(255) NOT NULL,
  `id_prestacion` int(255) NOT NULL,
  `cantidad` varchar(100) NOT NULL,
  `id_cobertura_social` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `prestaciones` (
  ...
  `expediente_osp` int(10) NOT NULL,
  `un_medico` decimal(10,4) NOT NULL,
  `un_gastos` decimal(10,4) NOT NULL,
  `activo` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `prestaciones` (`id`, `codigo`, `descripcion`, `nivel`, `complejidad`, `expediente_osp`, `un_medico`, `un_gastos`, `activo`) VALUES
(11, 'AS-02.02.04', 'BLEFAROCHALASIS', 1, 5, 6, '5.0000', '4.0000', 1),
(12, 'AS-02.02.02', 'BLEFAROPLASTIA', 2, 6, 8, '3.0000', '2.0000', 1),
(13, 'AS-02-02-02-1', 'BLEFAROPLASTIA AL 75 HON Y 50 GASTOS', 2, 5, 6, '8.0000', '4.0000', 1),
(14, 'AS-02.02.02-2', 'BLEFAROPLASTIA 50% HONORARIOS Y 30% GASTOS', 2, 6, 7, '4.0000', '7.0000', 1),
(15, 'AS-02.08.05-2', 'CATARATA FACOEM Y LIO 50% HON + 30% GTOS', 2, 8, 45, '4.0000', '5.0000', 1),
(16, 'AS-02.08.05-1', 'CATARATA FECOEM Y LIO AL 75 HON Y 50 GASTOS', 2, 5, 6, '8.0000', '4.0000', 1);
...
CREATE TABLE `roles` (
  `id` int(255) NOT NULL,
  `roles` varchar(50) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `tiempo_consulta`
--

CREATE TABLE `tiempo_consulta` (
  `id` int(255) NOT NULL,
  `id_medico` varchar(50) NOT NULL,
  `lun` varchar(100) NOT NULL,
  `mar` varchar(100) NOT NULL,
  `mie` varchar(100) NOT NULL,
  `jue` varchar(100) NOT NULL,
  `vie` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `tiempo_consulta`
--

INSERT INTO `tiempo_consulta` (`id`, `id_medico`, `lun`, `mar`, `mie`, `jue`, `vie`, `sab`, `dom`) VALUES
(3, '28', '20', '20', '20', '20', '20', '20', '-'),
(5, '40', '24', '20', '20', '20', '20', '20', '-'),
(11, '48', '20', '20', '20', '20', '20', '20', '-');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tipos_de_cobertura`
--

CREATE TABLE `tipos_de_cobertura` (
  `id` int(255) NOT NULL,
  `tipo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `tipos_de_cobertura`
--

INSERT INTO `tipos_de_cobertura` (`id`, `tipo`) VALUES
(1, 'Obra social'),
(2, 'Coseguro');
...
CREATE TABLE `turnos` (
  ...
  `id_medico` int(255) NOT NULL,
  `mSolicitante` varchar(100) NOT NULL,
  `mEfector` varchar(100) NOT NULL,
  `dni_solicitante` varchar(50) NOT NULL,
  `start` datetime NOT NULL,
  `end` datetime NOT NULL,
  `sobreturno` varchar(100) NOT NULL,
...
INSERT INTO `turnos` (`id`, `tipo_turno`, `title`, `id_medico`, `mSolicitante`, `mEfector`, `dni_solicitante`, `start`, `end`, `sobreturno`, `confirmado`, `urgencia`, `lente`, `diop`, `OI`, `OD`, `observacion`, `atendido`, `pago`, `n_cobro`, `ingreso`, `egreso`, `responsable`, `f_registro`, `primera_vez`) VALUES
(100, '1', 'DOLOR OD', 28, '-', '-', '34921176', '2021-05-11 16:00:00', '2021-05-11 16:19:00', '0', '0', '0', '-', '-', '0', '0', 'NATACIóN', '-', '0', 'Anulado', '-', '-', '1', '2021-05-07 19:14:51', '1'),
(101, '1', 'DOLOR OI', 28, '-', '-', '34921176', '2021-05-11 17:20:00', '2021-05-11 17:39:00', '0', '0', '0', '-', '-', '0', '0', 'CARPINTERO', '-', '0', 'Anulado', '-', '-', '1', '2021-05-07 18:28:15', '0'),
(102, '1', 'ARDOR', 28, '-', '-', '34921176', '2021-05-11 18:40:00', '2021-05-11 18:59:00', '0', '0', '0', '-', '-', '0', '0', 'SOL', '-', '0', 'Anulado', '-', '-', '1', '07-05-2021 15:43:59', '0'),
(104, '1', 'MOLESTIA', 28, '-', '-', '34921176', '2021-05-13 10:40:00', '2021-05-13 10:59:00', '0', '0', '0', '-', '-', '0', '0', 'CONJUNTIVITIS', '-', '0', '-', '-', '-', '1', '11-05-2021 05:03:59', '0'),
(105, '1', 'PRUEBA', 28, '-', '-', '41157219', '2021-05-17 08:00:00', '2021-05-17 08:19:00', '0', '0', '0', '-', '-', '0', '0', 'SDFDF', '-', '0', '-', '-', '-', '1', '2021-05-08 17:38:27', '1'),
(106, '1', 'DSDFSDF', 28, '-', '-', '34921176', '2021-05-18 17:00:00', '2021-05-18 17:19:00', '0', '0', '0', '-', '-', '0', '0', 'SDFDF', '-', '0', '-', '-', '-', '1', '2021-05-11 07:04:43', '0'),
(107, '1', 'XCVXCV', 28, '-', '-', '34921176', '2021-05-13 09:40:00', '2021-05-13 09:59:00', '0', '0', '0', '-', '-', '0', '0', 'XCVXCV', '-', '0', '-', '-', '-', '1', '2021-05-11 07:05:44', '0'),
(108, '1', 'DFGDFG', 28, '-', '-', '34921176', '2021-05-13 09:00:00', '2021-05-13 09:19:00', '0', '0', '0', '-', '-', '0', '0', 'DFGDG', '-', '0', '-', '-', '-', '1', '2021-05-11 07:06:43', '0');
...
CREATE TABLE `users` (
  ...
  `font_theme_color` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `user`, `pass`, `stat`, `apellido`, `nombre`, `avatar`, `activo`, `theme_color`, `font_theme_color`) VALUES
(1, 'admin', '123', '1', 'Veja', 'Juan Martin', 'default_user.jpg', 1, '70, 130, 180', '240, 248, 255'),
(2, 'josefina20', '123', '1', 'Fernandez', 'Josefina', 'Captura de pantalla 2021-03-05 164145.jpg', 1, '102, 51, 153', '240, 248, 255'),
(3, 'maca', '123', '1', 'Santiago', 'Macarena', 'default_user.jpg', 1, '70, 130, 180', '240, 248, 255'),
(4, 'gabi', '123', '1', 'Vargas', 'Gabriela', 'default_user.jpg', 1, '46, 139, 87', '240, 248, 255'),
(5, 'juanR', '123', '1', 'Veja Moreno', 'Juan', 'Captura de pantalla 2021-03-05 164301.jpg', 1, '46, 139, 87', '240, 248, 255'),
(7, 'juanM', '123', '1', 'Veja Moreno', 'Juan Martin', 'Captura de pantalla 2021-03-05 164045.jpg', 1, '46, 139, 87', '240, 248, 255'),
(8, 'ariel', '123', '1', 'Vedia', 'Ariel', 'default_user.jpg', 1, '46, 139, 87', '240, 248, 255'),
(9, 'ivanaV', '160781', '1', 'Villegas', 'Ivana', 'default_user.jpg', 1, '46, 139, 87', '240, 248, 255');
...
--
-- Indices de la tabla `categorias_iva`
--
ALTER TABLE `categorias_iva`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `coberturas_sociales`
--
ALTER TABLE `coberturas_sociales`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `dias_no_laborales`
--
ALTER TABLE `dias_no_laborales`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `dias_sin_atencion_medicos`
--
ALTER TABLE `dias_sin_atencion_medicos`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `medicos_coberturas_sociales`
--
ALTER TABLE `medicos_coberturas_sociales`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `otros_consultorios`
--
ALTER TABLE `otros_consultorios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `otros_horarios`
--
ALTER TABLE `otros_horarios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `otros_tiempos`
--
ALTER TABLE `otros_tiempos`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `pagos_metodos_de_pago`
--
ALTER TABLE `pagos_metodos_de_pago`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pagos_prestaciones`
--
ALTER TABLE `pagos_prestaciones`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tiempo_consulta`
--
ALTER TABLE `tiempo_consulta`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tipos_de_cobertura`
--
ALTER TABLE `tipos_de_cobertura`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `categorias_iva`
--
ALTER TABLE `categorias_iva`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `coberturas_sociales`
--
ALTER TABLE `coberturas_sociales`
...
--
-- AUTO_INCREMENT de la tabla `dias_no_laborales`
--
ALTER TABLE `dias_no_laborales`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `dias_sin_atencion_medicos`
--
ALTER TABLE `dias_sin_atencion_medicos`
...
--
ALTER TABLE `localidades`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2383;
...
--
-- AUTO_INCREMENT de la tabla `medicos_coberturas_sociales`
--
ALTER TABLE `medicos_coberturas_sociales`
...
--
-- AUTO_INCREMENT de la tabla `otros_consultorios`
--
ALTER TABLE `otros_consultorios`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `otros_horarios`
--
ALTER TABLE `otros_horarios`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `otros_tiempos`
--
ALTER TABLE `otros_tiempos`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `pagos_metodos_de_pago`
--
ALTER TABLE `pagos_metodos_de_pago`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pagos_prestaciones`
--
ALTER TABLE `pagos_prestaciones`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT de la tabla `tiempo_consulta`
--
ALTER TABLE `tiempo_consulta`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `tipos_de_cobertura`
--
ALTER TABLE `tipos_de_cobertura`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
